  ...
  const handlePrintMachineReport = (machine: MachineProduction) => {
    ...
    printWindow.document.write(`
      ...
      <body>
        ...
        <div class="info-row"><span class="label">${t('production.monitoring.report.reportDate')}:</span><span class="value">${new Date().toLocaleString('ar-EG')}</span></div>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td>${t('production.monitoring.report.lastProduction')}</td><td>${machine.last_production ? new Date(machine.last_production).toLocaleString('ar-EG') : '-'}</td></tr>
          </tbody>
        </table>
