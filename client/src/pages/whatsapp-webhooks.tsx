...
export default function WhatsAppWebhooks() {
  ...
  return (
    <PageLayout
      title="إدارة WhatsApp Webhooks"
      description="تكوين واختبار webhooks للواتساب"
    >
        ...
        <Alert>
          ...
          <AlertDescription className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 text-sm">
              ...
              <li>
                يجب أن يكون لديك HTTPS للـ webhooks في الإنتاج (Replit توفر ذلك
                تلقائياً)
              </li>
              <li>Meta تتحقق من الـ webhook باستخدام GET request قبل حفظه</li>
