...
export default function ProductionStageStats({
  stage,
  data,
  ...
  const calculateStats = () => {
              ...
              po.rolls.forEach((roll: any) => {
                ...
                if (
                  ...
                  (roll.cut_weight_total_kg &&
                    parseFloat(roll.cut_weight_total_kg) > 0)
                ) {
                  completedRolls++;
                }
              });
    ...
    const progressPercentage =
      totalRolls > 0 ? Math.round((completedRolls / totalRolls) * 100) : 0;
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            {t("production.stats.ordersInQueue")}
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            {t("production.stats.rollsInQueue")}
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">
            {t("production.stats.totalWeight")}
          </CardTitle>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">
            {t("production.stats.progressRate")}
          </CardTitle>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            {stats.completedRolls} / {stats.totalRolls}{" "}
            {t("production.stats.rollCompleted")}
          </p>
        </CardContent>
      </Card>
    </div>
