        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">
                {t("production.table.requiredQuantity")}
              </th>
              <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">
                {t("production.table.producedQuantity")}
              </th>
              <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                <div>
                  <span className="text-muted-foreground">
                    {t("production.table.required")}:
                  </span>
                  <div className="font-medium">{formatWeight(required)}</div>
                </div>
                <div>
                  <span className="text-muted-foreground">
                    {t("production.table.produced")}:
                  </span>
                  <div className="font-medium">{formatWeight(produced)}</div>
                </div>
              </div>
              <div>
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  onClick={() => onCreateRoll(order.id)}
                  className="flex-1"
                  data-testid={`button-create-roll-mobile-${order.id}`}
                >
