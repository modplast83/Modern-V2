...
export const aiAgentKnowledgeRelations = relations(
  aiAgentKnowledge,
  ({ one }) => ({
    user: one(users, {
...
export const aiAgentSettingsRelations = relations(
  aiAgentSettings,
  ({ one }) => ({
    user: one(users, {
...
export const consumablePartsTransactionsRelations = relations(
  consumablePartsTransactions,
  ({ one }) => ({
...
export const erpEntityMappingsRelations = relations(
  erpEntityMappings,
  ({ one }) => ({
...
export const erpConfigurationsRelations = relations(
  erpConfigurations,
  ({ many }) => ({
...
export const erpFieldMappingsRelations = relations(
  erpFieldMappings,
  ({ one }) => ({
    erpConfiguration: one(erpConfigurations, {
...
export const erpSyncSchedulesRelations = relations(
  erpSyncSchedules,
  ({ one }) => ({
    erpConfiguration: one(erpConfigurations, {
...
export const notificationEventSettingsRelations = relations(
  notificationEventSettings,
  ({ one, many }) => ({
    user_createdBy: one(users, {
...
export const notificationEventLogsRelations = relations(
  notificationEventLogs,
  ({ one }) => ({
