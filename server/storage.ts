      ...
      async () => {
        ...
        const rollsData = await db
          .select({
            ...
            customer_name_en: sql<string>`COALESCE(${customers.name}, '')`,
            weight_kg: weightCol,
            stage: rolls.stage,
            section: sql<string>`${section}`,
            created_at: dateCol,
      ...
      async () => {
        ...
        const ordersData = await db
          .select({
            ...
            customer_name: sql<string>`COALESCE(${customers.name_ar}, ${customers.name})`,
            customer_name_ar: customers.name_ar,
            customer_name_en: customers.name,
            product_name: sql<string>`COALESCE(${items.name_ar}, ${items.name})`,
            product_name_ar: items.name_ar,
            product_name_en: items.name,
            order_status: orders.status,
        ...
        const groupedByOrder = rollsData.reduce((acc: any, roll: any) => {
          ...
          if (!acc[orderId]) {
            acc[orderId] = {
              ...
              customer_name_en: roll.customer_name_en,
              product_name: roll.product_name,
              product_name_ar: roll.product_name_ar,
              product_name_en: roll.product_name_en,
